			...
			if(data.success){
			 $.each(data.data,function(i,houses) {
				 ...
				 var item='<li class="clearfix"><div class="collect-pic"><a href="'+url+'/article.html?id='+houses['id']+'"><img src="'+url+'/upload/'+photo+'" height="160" width="218" alt=""></a>'+
					...
					'<i class="green2">&#xe65b;</i></h3><p>'+houses['room']+'|'+houses['paymethod']+'|'+houses['hlevel']+'|'+houses['floor']+'/'+houses['countfloor']+'层</p>'+
...
/*............................延迟执行.................................*/	
function queryHousesByRadio(s){
		
	 var radioId = s.previousSibling.id;
